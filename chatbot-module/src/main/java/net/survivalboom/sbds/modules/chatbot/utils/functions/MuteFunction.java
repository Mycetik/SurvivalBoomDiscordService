...
@JsonClassDescription("Тимчасово забрати можливість надсилати повідомлення у користувача")
public class MuteFunction implements Functional {
    ...
    public Object execute() {
        ...
        var mute = module.getModerationModule().getMuteManager().mute(guild, user, botUser, reason, comment, duration).join();

        var msg = MessageBuilder.create(module.getSbds().getMessages(), "moderation.command.mute.success", guild)
                .withPlaceholders(
        ...
        module.getLogger().info("[{}] {} added mute {}.", guild.getName(), botUser.getEffectiveName(), mute);
