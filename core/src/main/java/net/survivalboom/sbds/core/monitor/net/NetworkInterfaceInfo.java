 ...
 */
public final class NetworkInterfaceInfo implements INetworkInterfaceInfo {
    ...
    public long getBytes(Direction direction) {
        return switch (direction) {
            case RECEIVE -> getReceivedBytes();
            case TRANSMIT -> getTransmittedBytes();
        };
    }
    ...
    public long getPackets(Direction direction) {
        return switch (direction) {
            case RECEIVE -> getReceivedPackets();
            case TRANSMIT -> getTransmittedPackets();
        };
    }
     ...
     */
    public static @NotNull Map<String, NetworkInterfaceInfo> difference(Map<String, NetworkInterfaceInfo> current, Map<String, NetworkInterfaceInfo> previous) {
        if (previous == null || previous.isEmpty()) {
            return current;
        }

        Map<String, NetworkInterfaceInfo> builder = new HashMap<>();
     ...
     */
    public static @NotNull Map<String, NetworkInterfaceInfo> pollSystem() {
        try {
    ...
    static @NotNull Map<String, NetworkInterfaceInfo> read(List<String> output) {
