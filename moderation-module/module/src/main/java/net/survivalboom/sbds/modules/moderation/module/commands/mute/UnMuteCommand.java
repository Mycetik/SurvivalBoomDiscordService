...
@CommandClass(name = "unmute", description = "Removes a mute from a user in a guild", permission = "moderation.command.unmute", translationKey = "moderation.command.unmute")
